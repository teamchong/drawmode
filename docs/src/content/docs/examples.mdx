...
![Flowchart](/drawmode/examples/flowchart.png)

---

:::tip[Try it yourself]
Copy any example above into a Claude Code or Cursor session with drawmode configured. Or run examples locally: `npx tsx docs/generate-examples.ts`
:::
